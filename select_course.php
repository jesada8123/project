...
//query
$query=mysqli_query($conn,"SELECT year(d_id2) FROM year WHERE year_number LIKE '%$search%'");
					...
					<th width = '8%'> ลบ</th>
						...
						<tbody>
							...
							<tr>
								...
								<td><center><?php echo "<a href='update_form_course.php?year_ID=".$crow['year_ID']."'><img src='edit.png' width='20px' height='20px'></a></td></a>"; ?></td>
								<td><center><?php echo "<a href='delete_course.php?year_ID=".$crow['year_ID']."' onclick='return confirm(\"คุณต้องการที่จะลบข้อมูลนี้หรือไม่ ?\")'><img src='delete.png' width='20px' height='20px'></a></td></a>"; ?></td>
							</tr>
							<?php
									}
							?>
...
<!-- Ref : 
	...
	-->
	<a href="insert_form_course.php"><center>เพิ่มข้อมูล</center></a><00>